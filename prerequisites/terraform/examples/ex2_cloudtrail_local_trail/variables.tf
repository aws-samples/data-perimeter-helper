...
variable "profile_name_org_member_1_account" {
  description = "AWS Profile to be used to deploy to the org member 1 (example)"
  type        = string
}

variable "profile_name_org_member_2_account" {
  description = "AWS Profile to be used to deploy to the org member 2 (example)"
  type        = string
}
